"use strict";
define('datatypes/lambda', ['utils', 'utils/operationutils', 'internaltypes/varscope', 'internaltypes/varref', 'internaltypes/twineerror'], ({nth}, {objectName}, VarScope, VarRef, TwineError) => {
	/*d:
		Lambda data
		...
		apply(section, {loop:loopArg, pos:lambdaPos /*This must be 1-indexed*/, making:makingArg, ignoreVia, tempVariables}) {
			...
			*/
			if (originalReplay && (hasWhere || via)) {
				...
				*/
				last.lambda.loops.push(Object.assign({
						it: loopArg,
						/*
