			...
			(/* no cd because this is attachable:false */ section, slotName) => {
				...
				*/
				...
				if (result instanceof Error) {
					...
					*/
					const d = dialogElement("Sorry to interrupt... The story tried to load saved data, but there was a problem.\n"
							+ result.message
		...
		*/
		("alert",
			...
			(/* no cd because this is attachable:false */ section, text) => {
				Utils.storyElement.append(dialogElement(text, false, () => section.unblock()));
	...
	*/
	Macros.add
		...
		*/
		("confirm",
			(section, text) => {
				Utils.storyElement.append(dialogElement(text, false, () => section.unblock(false), () => section.unblock(true)));
			},
			[String])
