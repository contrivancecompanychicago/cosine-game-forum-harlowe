...
uglify_flags = -c --comments -m -b beautify=false,ascii-only=true
...
examplestory = "{{STORY_DATA}}", "<tw-storydata startnode=1><tw-passagedata pid=1 name=Start>(enchant:?Page,(background:white)+(color:black))[[Next]]</tw-passagedata><tw-passagedata pid=2 name=Next>[[Last]]</tw-passagedata><tw-passagedata pid=3 name=Last>**Success**</tw-passagedata></tw-storydata>"
